...
namespace Kurenai
{
    struct WaterSettings
    {
        ...
        // trueにすると波のスクロールが止まる(m_Settings.Sky.TimeAutoAdvanceの水面版に近いが、
        ...
        // (m_Settings.Reflection.ModeがScene.SSREnabledから初期化されるのと同じ設計、ApplyLoadedScene参照)。
        ...
        // 効果が出るのはm_Settings.Reflection.Mode==ScreenSpaceのときだけで、かつ手続き空が無効な
