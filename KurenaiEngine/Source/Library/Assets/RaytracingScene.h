...
namespace Kurenai::Assets
{
    ...
    // HLSL側の対応: struct RTMeshInfo { uint AttributeOffset; uint IndexOffset; uint MaterialIndex; uint Padding; };
    ...
    static_assert(sizeof(RaytracingMeshInfo) == 16, "HLSL側のRTMeshInfoと一致させるため16バイト固定");
